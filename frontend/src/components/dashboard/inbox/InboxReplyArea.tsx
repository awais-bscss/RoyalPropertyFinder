        ...
        {attachments.length > 0 && (
          <div className="flex flex-col gap-1 mb-1">
            {attachments.map((file, i) => (
              <div key={i} className="flex items-center justify-between bg-white dark:bg-slate-800 p-2 rounded-sm border border-royal-200 dark:border-royal-900 text-[11px] shadow-sm">
        ...
        <div className="flex flex-col gap-2 p-3 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-sm hover:border-slate-300 dark:hover:border-slate-600 focus-within:ring-2 focus-within:ring-royal-600/20 focus-within:border-royal-600 transition-all duration-200">
          <div className="flex items-center gap-3">
            ...
            <textarea 
              ...
              className="flex-1 bg-transparent border-none focus:ring-0 focus:outline-none text-[14px] font-sans font-medium resize-none py-1.5 scrollbar-thin max-h-[100px] overflow-y-auto dark:text-white" 
              rows={1} 
              onInput={(e) => {
